        ...
        <section className="bch" id='bch'>
            ...
            <div className="bch__data">
                ...
                <div className="bch__data-text">
                    ...
                    The Executive Committee of the Youth Union
                    </h1>
                ...
                <div className='bch__leader'>
                    {
                        [...Array(2)].map((_, i) => (
                            <div key={i} className='bch__card'>
                                ...
                                <h3 className='bch__card-subtitle' style={{ color: bch2223[i].color }}>{bch2223[i].jobEn}</h3>
                            </div>
                        ))
                    }
                </div>
                <div className='bch__teams gridCol__3'>
                    {
                        [...Array(3)].map((_, i) => (
                            <div key={i} className='bch__card'>
                                ...
                                <h3 className='bch__card-subtitle' style={{ color: bch2223[i + 2].color }}>{bch2223[i + 2].jobEn}</h3>
                            </div>
                        ))
                    }
                ...
                <div className='bch__teams gridCol__4'>
                    {
                        [...Array(12)].map((_, i) => (
                            <div key={i} className='bch__card'>
                                ...
                                <h3 className='bch__card-subtitle' style={{ color: bch2223[i + 5].color }}>{bch2223[i + 5].jobEn}</h3>
                            </div>
                        ))
                    }
                </div>

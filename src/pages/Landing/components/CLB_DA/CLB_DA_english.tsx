...
import './CLB_DA.css'
function CLB_DA_english({ initial }: any) {
    useEffect(() => {
    ...
    return <section className="clbdas section" id="clbda">
        ...
        <div className='clbdas__filters'>
            ...
            <div className='clbdas__slider'>
                ...
                <span className="clbdas__item" data-filter=".vh">Cultures</span>
                <span className="clbdas__item" data-filter=".knnt">Skills - Art</span>
                <span className="clbdas__item" data-filter=".httt">Academic - Information</span>
        ...
        <div className="clbdas__container container grid">
            {
                clbinfo.map((data: any, index: any) => (
                    <a key={index} href={`clbinfo/` + data.idEn.replace(/\./g, "-")} className={`clbdas__card mix ${data.tag}`}>
